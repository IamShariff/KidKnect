...
public class SecurityConfig {
	...
	UserDetailsService userDetailsService() {
		return new SpringUserDetailsService(studentRepository, teacherRepository);
	}
	...
	SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		...
		}).authorizeHttpRequests(auth -> auth.requestMatchers("auth/**","teacher/add-princial").permitAll()
				.requestMatchers(AUTH_ALLOWED).permitAll().anyRequest().authenticated())
